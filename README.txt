...
a persistence unit "pretest2PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "pretest2/pom.xml":
...
artifacts ("pretest2-ejb.jar" and "pretest2-web.war") are already built. You can build
